        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between sm:items-center">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="inline-flex items-center text-lg text-text-secondary hover:text-text-primary transition-colors"
              aria-label="GitHub yasirimran4"
            >
              <svg className="mr-2 h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
